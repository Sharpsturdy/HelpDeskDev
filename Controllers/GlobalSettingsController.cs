...
namespace Help_Desk_2.Controllers
{
    ...
    public class GlobalSettingsController : Controller
    {
        ...
        public ActionResult Index([Bind(Include = "ID,TicketSeeder,TicketHeader,TicketHeaderEnabled,TicketExpiryDays,FAQsExpiryDays,KBExpiryDays,HelpFile")] GlobalSettings globalSettings)
        {
            if (!AllSorts.userHasRole("AdminUsers"))
                return new HttpStatusCodeResult(HttpStatusCode.Unauthorized);
